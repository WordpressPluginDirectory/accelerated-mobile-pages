	...
	<div class="amp-wp-content post-pagination-meta ampforwp-social-icons-wrapper ampforwp-so-i">
	    ...
	    $data_param_data = str_replace('@', '', $data_param_data);?>
			<amp-social-share type="twitter"
												...
												<?php ampforwp_rel_attributes_social_links(); ?>
												data-param-url=""
                        						data-param-text="TITLE <?php echo esc_url($twitter_amp_permalink).' '.esc_attr(ampforwp_translation( $redux_builder_amp['amp-translator-via-text'], 'via' )).' '.esc_attr($data_param_data) ?>"
			></amp-social-share>
		<?php } ?>
